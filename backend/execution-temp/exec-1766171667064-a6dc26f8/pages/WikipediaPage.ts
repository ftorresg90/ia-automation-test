...
export class WikipediaPage extends BasePage {
    ...
    readonly tituloContengaInteligenciaSelectors: string[] = ['xpath=//*[contains(translate(normalize-space(.), "ABCDEFGHIJKLMNOPQRSTUVWXYZ", "abcdefghijklmnopqrstuvwxyz"), \'titulocontengainteligencia\')]', '#frequencyGrid', 'xpath=//*[contains(translate(normalize-space(.), "ABCDEFGHIJKLMNOPQRSTUVWXYZ", "abcdefghijklmnopqrstuvwxyz"), \'one\')]', 'div.overlay-banner-main-frequency.button-grid'];
    readonly tituloContengaInteligencia: Locator;
    ...
    constructor(page: Page) {
        ...
        this.tituloContengaInteligencia = this.page.locator(this.tituloContengaInteligenciaSelectors[0]);
    }
    ...
    async verifyTituloContengaInteligencia(expectedText: string) {
        await this.smartVerify(this.tituloContengaInteligenciaSelectors, expectedText);
    }
}