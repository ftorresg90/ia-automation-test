...
export class SaucedemoPage extends BasePage {
    ...
    readonly loginSelectors: string[] = ['#login_credentials', '#login-button', 'div[id*="login_credentials"]', 'input[name="login-button"]', '#login_button_container', 'div.login_credentials_wrap-inner', 'div.login_container', 'div.login_logo', 'div.login_password'];
